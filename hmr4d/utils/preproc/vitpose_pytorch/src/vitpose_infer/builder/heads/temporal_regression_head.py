...
from mmpose.core import WeightNormClipHook, compute_similarity_transform, fliplr_regression
    ...
    def inference_model(self, x, flip_pairs=None):
        ...
        if flip_pairs is not None:
            output_regression = fliplr_regression(
                output.detach().cpu().numpy(), flip_pairs, center_mode="static", center_x=0
            )
        else:
